...
import { Vector3 as Vector3$1, Object3D, PlaneGeometry, Mesh, MeshBasicMaterial, DoubleSide, VideoTexture, CanvasTexture, TextureLoader, ClampToEdgeWrapping, LinearFilter, MeshDepthMaterial, RGBADepthPacking, RGBAFormat, RGBA_ASTC_4x4_Format, RGBA_BPTC_Format, RGBA_ETC2_EAC_Format, RGBA_PVRTC_4BPPV1_Format, RGBA_S3TC_DXT5_Format, RGB_ETC1_Format, RGB_ETC2_Format, RGB_PVRTC_4BPPV1_Format, RGB_S3TC_DXT1_Format, Loader, FileLoader, CompressedTexture, UnsignedByteType, LinearMipmapLinearFilter, sRGBEncoding, LinearEncoding } from "three";
const _lut = [];
for (let i = 0; i < 256; i++) {
...
__publicField(WebRenderer, "textEncoder", new TextEncoder());
  ...
  for (const record of records) {
    ...
    if (record.type === "characterData") {
      ...
      if (((_a2 = target3.parentElement) == null ? void 0 : _a2.tagName.toLowerCase()) === "style") {
        ...
        style.getRootNode();
        _WebRenderer.embeddedStyles.delete(style);
      }
    }
...
const _WebLayer3D = class extends Object3D {
  constructor(element, container) {
    ...
    __publicField(this, "domSize", new Vector3$1(1, 1, 1));
