<template>
  ...
  <div style="float: right;">
    <span xr-layer @click="linkClick" class="alink"><a href="https://www.ted.com/talks/chris_milk_how_virtual_reality_can_create_the_ultimate_empathy_machine?language=yi" target="_blank">Click here to learn more about the video</a></span>  
  </div>
  </div>
  </div>
  </div> 
