<template>
 ...
 <div class="spacer-side">
  ...
  <br><br>
   ...
   <span xr-layer @click="linkClick" class="xrlink alink"><a href="https://www.youtube.com/watch?v=X9jM4LcwHog&t=55s&ab_channel=FeelVirtual" target="_blank" id="Cybersickness_link">Click here to learn more about the video</a></span></div>
